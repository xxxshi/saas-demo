...
public class CustomWebResponseExceptionTranslator implements WebResponseExceptionTranslator<OAuth2Exception> {
    ...
    public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
        ...
        ase = (UaaAccountBizException) throwableAnalyzer.getFirstThrowableOfType(
            UaaAccountBizException.class, causeChain);
        if (ase instanceof UaaAccountBizException) {
            return handleOAuth2Exception(new CustomWebResponseExceptionTranslator.UaaAccountException(ase.getMessage(), ase));
        }
    ...
    @SuppressWarnings("serial")
    private static class UaaAccountException extends OAuth2Exception {

        public UaaAccountException(String msg, Throwable t) {
            super(msg, t);
        }

        @Override
        public String getOAuth2ErrorCode() {
            return "uaa_account_biz_error";
        }
